...
omniql is opinionated way to create schema and define commons operation over them, is intended to be useful  for large project where tems of diferent background converge,
